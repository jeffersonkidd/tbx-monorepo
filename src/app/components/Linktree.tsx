      ...
      <div className="relative z-10 w-full max-w-md bg-white border-8 border-black shadow-[16px_16px_0px_0px_#000] p-8 pb-12">
        ...
        <div className="flex flex-col items-center mb-8 relative">
          <div className="w-32 h-32 mb-6 relative group cursor-pointer">
            ...
            <img 
              src="https://images.unsplash.com/photo-1620122303020-87ec826cf70d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb29sJTIwcGVyc29uJTIwcG9ydHJhaXQlMjBibGFjayUyMGFuZCUyMHdoaXRlfGVufDF8fHx8MTc3OTk5OTM2Nnww&ixlib=rb-4.1.0&q=80&w=1080" 
              alt="Creator Profile" 
